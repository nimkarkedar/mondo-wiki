        ...
        <div className="flex flex-col gap-10 pr-8 md:pr-16">
          ...
          <div>
            ...
            <p className="text-[18px] text-black leading-relaxed">
              Ask TGP is an AI oracle built on over 300 conversations that <a href="https://www.nimkarkedar.com/about" target="_blank" rel="noopener noreferrer" className="underline">Kedar Nimkar</a> has recorded with some of the finest minds from India&apos;s creative world, representing more than 50,000 minutes of dialogue from his podcast, The Gyaan Project. Ask it anything, and it responds with a short answer and a long answer, drawn from those conversations. Expect philosophical answers — insights more than instructions.
            </p>
          </div>
